// 컴포넌트가 function, class로 묶어 재사용할 수 있도록 만들어준
// 함수나 클래스
...
function AnimalSound(){
    ...
    useEffect(() => {
        // console.log 안에 함수나 변수명을 사용하고자 한다면 
        // '' "" 대신에 `` 사용 
        
        // 연결될 때 바로 실행이 되는 부분

        // 마운트 될 때 바로 실행이 되는 부분
        ...
        // [animal] animal 이라는 값이 변경될 때마다 useEffect 
        // 안에 작성한 내부 코드를 다시 실행하기 위해 작성
        // [] 추후에는 animal 하나만 들어있는 것이 아니라
        // 여러 변수들이 들어있을 수 있으므로 배열로 묶어주는 것
    }, [animal]); // animal 이 바뀔때마다 실행
